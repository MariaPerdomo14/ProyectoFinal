...
public class clsPosiblesClientes {
    ...
    public String getStCorreoElecronico() {
        return stCorreoElecronico;
    }

    public void setStCorreoElecronico(String stCorreoElecronico) {
        this.stCorreoElecronico = stCorreoElecronico;
    }
    ...
    public void setChNoParticipacionCorreoEletronico(char chNoParticipacionCorreoEletronico) {
        this.chNoParticipacionCorreoEletronico = chNoParticipacionCorreoEletronico;
    }
    ...
    public String getStCorreoElecronicoSecundario() {
        return stCorreoElecronicoSecundario;
    }
    ...
    public String stCorreoElecronico;
    ...
    public char chNoParticipacionCorreoEletronico;
