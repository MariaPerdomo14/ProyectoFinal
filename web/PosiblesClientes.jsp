                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success btn-sm"
                                                   href="PosiblesClientesController?stOption=M&codigoSeleccionado"<%= item.getInCodigo() %>">
                                                Modificar</a>
                                                <a class="btn btn-danger btn-sm"
                                                   href="PosiblesClientesController?stOption=E&codigoSeleccionado"<%= item.getInCodigo() %>">
                                                Eliminar</a>
                                            </td>
                                        </tr>
                                        <%
